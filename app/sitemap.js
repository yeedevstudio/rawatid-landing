export default async function sitemap() {
  try {
    ...
    return [
      ...
      {
        url: "https://www.rawat.id/fitur",
        lastModified: new Date().toISOString(),
        changeFrequency: "monthly",
        priority: 0.8,
      },
      {
        url: "https://www.rawat.id/register",
        lastModified: new Date().toISOString(),
        changeFrequency: "weekly",
        priority: 0.8,
      },
      {
        url: "https://www.rawat.id/blog",
        lastModified: new Date().toISOString(),
        changeFrequency: "daily",
        priority: 1,
      },
      {
        url: "https://www.rawat.id/blog/semua",
        lastModified: new Date().toISOString(),
        changeFrequency: "daily",
        priority: 0.8,
      },
      ...
      ...authors.map((author) => ({
        url: `https://www.rawat.id/blog/penulis/${author?.slug}`,
        lastModified: new Date().toISOString(),
        changeFrequency: "daily",
        priority: 0.6,
      })),
      ...posts.map((post) => ({
        url: `https://www.rawat.id/blog/detail/${post?.slug}`,
