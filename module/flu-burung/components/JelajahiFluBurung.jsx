...
const ITEMS = [
  {
    ...
    title: <>Apa Itu Flu Burung <em>(Avian Influenza)</em>?</>,
    description: <>Penjelasan mengenai definisi Flu Burung <em>(Avian Influenza)</em>?</>,
    Icon: IconInfoCircle,
    linked: true,
  },
  {
...
export default function JelajahiFluBurung() {
  return (
