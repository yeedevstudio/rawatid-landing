...
const ITEMS = [
  {
    id: "apa-itu-polio",
    title: "Apa Itu Poliomielitis?",
    description: "Penjelasan mengenai definisi Poliomielitis",
    Icon: IconInfoCircle,
  },
  {
    id: "penyebab-risiko",
...
function ExploreCard({ item }) {
  ...
  if (item.id === "apa-itu-polio" || item.id === "penyebab-risiko") {
    return (
...
export default function JelajahiInformasi() {
  return (
