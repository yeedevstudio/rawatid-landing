    ...
    >
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
        ...
        <div className="flex flex-col gap-4 md:gap-5">
          ...
          <div className="flex gap-3 md:gap-[16px] items-center pt-2 flex-wrap">
            <Button
              aria-label="Mulai Sekarang"
              className="bg-white text-[#038F7A] text-[15px] sm:text-[18px] md:text-[20px] lg:text-[24px] font-semibold border-0 shadow-none flex-1 sm:flex-none h-[48px] md:h-[58px] lg:h-[62px] px-4 md:px-[18px] py-2 md:py-[12px] rounded-[12px] md:rounded-[16px] hover:bg-white/90"
            ...
            <Button
              ...
              className="bg-transparent text-white text-[15px] sm:text-[18px] md:text-[20px] lg:text-[24px] font-semibold border border-white shadow-none flex-1 sm:flex-none h-[48px] md:h-[58px] lg:h-[62px] px-4 md:px-[18px] py-2 md:py-[12px] rounded-[12px] md:rounded-[16px] hover:bg-white/10"
