  ...
  return (
    <section className="w-full px-5 pb-8 pt-12 md:px-12 md:pb-10 md:pt-16 lg:px-20 lg:pb-12 lg:pt-20 xl:px-24">
      <div className="grid grid-cols-1 items-center gap-10 lg:grid-cols-2 lg:gap-16">
        <div className={`flex max-w-none flex-col gap-4 text-left md:gap-6 ${CACAR_AIR_CONTENT_INSET}`}>
        ...
        <img src="/image/cacarair.png" alt="Ilustrasi cacar air dan cacar ular" className="h-auto w-full max-w-lg justify-self-center lg:max-w-none" />
      </div>
    </section>
  );
}
