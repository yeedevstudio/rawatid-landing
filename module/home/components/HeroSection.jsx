    ...
    <section className="my-8 md:my-10 w-full px-5 md:px-12 lg:px-20 xl:px-24 grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center overflow-hidden">
      ...
      >
        ...
        <div className="pt-2 md:pt-6 w-full lg:w-[480px]">
          <Button aria-label="Jelajahi" className="bg-[#038F7A] text-white text-[15px] sm:text-[18px] md:text-[22px] lg:text-[28px] font-semibold hover:bg-[#038F7A]/90 shadow-none w-full h-[48px] sm:h-[58px] md:h-[68px] lg:h-[79px] px-4 md:px-[26px] py-2 md:py-[18px] rounded-[12px] md:rounded-[16px]" onClick={() => router.push("/register")}>
            Jelajahi
          </Button>
        </div>
      </div>
