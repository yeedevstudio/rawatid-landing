...
const ITEMS = [
  {
    id: "apa-itu",
    title: "Apa Itu Herpes Simplex?",
    description: "Penjelasan mengenai definisi Herpes Simplex",
    Icon: IconInfoCircle,
    hrefId: "apa-itu",
  },
  {
    id: "penyebab",
    title: "Penyebab",
    description: "Kenali penyebab yang terjadi pada masing masing penyakit",
...
function ExploreCard({ item }) {
  ...
  const className = `flex min-h-[240px] min-w-0 flex-col items-stretch justify-start gap-4 rounded-[16px] border border-neutral-200/90 bg-white px-5 py-7 ${HERPES_CARD_BOX_SHADOW} md:min-h-[268px] md:gap-[1.125rem] md:px-5 md:py-8`;
...
export default function HerpesExploreSection() {
  return (
